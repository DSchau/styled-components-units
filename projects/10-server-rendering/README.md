...
1.  `cd projects/10-server-rendering/`
...
[![Edit projects/10-server-rendering/](https://codesandbox.io/static/img/play-codesandbox.svg)](https://codesandbox.io/s/github/DSchau/styled-components-units/tree/master/projects/10-server-rendering/)
